    ...
    <>
      {items.map((items, i) => {
        ...
        return (
          <div
            key={i}
            className="rounded-xl estiva_cate_car p-6 hover:scale-104 group cursor-pointer transition ease-in-out "
          >
            <div className=" flex flex-wrap ">
              ...
              <div className="estiva_cate_icon w-[25%] max-sm:w-[23%] max-md:w-[25%] max-sm:hidden px-2">
                <Image
                  ...
                  src={icon}
                  alt={imgalt}
                  className="group-hover:scale-120 transition ease-in-out  duration-300 max-w-[130px] "
                />
              </div>
            </div>
          </div>
