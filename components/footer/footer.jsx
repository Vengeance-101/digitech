...
const FooterBottom = () => {
  return (
    <>
      <section className="py-4 relative bg-bg-estiva-footer lg:px-20 divide-devider-color border-b-1 text-gray-300 ">
      ...
      <section className="py-10 estiva_gradient footer_border  text-gray-300 footer_box">
        <div className="container mx-auto">
          <div className="flex">
            <div className="w-full text-center leading-6 mb-4">
              <p>DigiTechMate is Collab with (www.estivasoftech.com)</p>
              <p>
